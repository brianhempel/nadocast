...
function write_15km_HREF_probs_grib2(probs :: AbstractVector; run_time :: Dates.DateTime, forecast_hour :: Union{Int64,Tuple{Int64,Int64}}, event_type :: String, out_name :: String)
  var_name = Dict(
    "tornado"           => "TORPROB",
    "wind"              => "WINDPROB",
    "wind_adj"          => "WINDPROB",
    ...
    "sig_wind"          => "SWINDPRO",
    "sig_wind_adj"      => "SWINDPRO",
    "sig_hail"          => "SHAILPRO",
    "tornado_life_risk" => "STORPROB",
  )[event_type]
  ...
  run(`$(wgrib2_path()) $grib2_template_path -no_header -ncpu 1 -import_bin $tmp_path -set_var $var_name -set_date $date_str -set_ftime $fcst_str -set_prob 1 1 3 0 100 -set_grib_type jpeg -grib_out $out_name`)
