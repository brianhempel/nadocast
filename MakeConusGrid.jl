...
function grid_to_conus(grid :: Grids.Grid) :: Array{Float32,1}
  ArchGDAL.registerdrivers() do
    ArchGDAL.read((@__DIR__) * "/geo_regions/ln_us/ln_us.shp") do dataset # Have to use this original file. GDAL is finicky about the geometry created by attempting to simplify it.
