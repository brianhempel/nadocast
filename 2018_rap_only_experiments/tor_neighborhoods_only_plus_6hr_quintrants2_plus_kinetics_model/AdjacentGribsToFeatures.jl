...
# need to read the wind/temp/rh/height at all pressures to calculate AGL versions
# but won't use all in the final
const LAYERS = readdlm(IOBuffer("""4LFTX:180-0 mb above ground
ABSV:500 mb
...
# readdlm conveniently filters out lines starting with "#"
layers_to_use = readdlm(IOBuffer("""4LFTX:180-0 mb above ground
ABSV:500 mb
CAPE:180-0 mb above ground
CAPE:255-0 mb above ground
CAPE:90-0 mb above ground
...
HGT:cloud base
HGT:cloud top
# HGT:convective cloud top level # Alas this field is broken in RAP v4 and we may need to do without
HGT:equilibrium level
# HGT:highest tropospheric freezing level
HGT:lowest level of the wet bulb zero
HGT:planetary boundary layer
...
layers_to_use = vcat(layers_to_use, [
  "TMP" "250 m above ground computed" ;
  "TMP" "500 m above ground computed" ;
  "TMP" "750 m above ground computed" ;
  "TMP" "1000 m above ground computed" ;
  "TMP" "1500 m above ground computed" ;
  "TMP" "2000 m above ground computed" ;
  "TMP" "3000 m above ground computed" ;
  "TMP" "4500 m above ground computed" ;
  "TMP" "5000 m above ground computed" ;
  "TMP" "6000 m above ground computed" ;
  "TMP" "7000 m above ground computed" ;
  "TMP" "8000 m above ground computed" ;
  "TMP" "9000 m above ground computed" ;
  "TMP" "10000 m above ground computed" ;
  "TMP" "11000 m above ground computed" ;
  "RH" "250 m above ground computed" ;
  "RH" "500 m above ground computed" ;
  "RH" "750 m above ground computed" ;
  "RH" "1000 m above ground computed" ;
  "RH" "1500 m above ground computed" ;
  "RH" "2000 m above ground computed" ;
  "RH" "3000 m above ground computed" ;
  "RH" "4500 m above ground computed" ;
  "RH" "5000 m above ground computed" ;
  "RH" "6000 m above ground computed" ;
  "RH" "7000 m above ground computed" ;
  "RH" "8000 m above ground computed" ;
  "RH" "9000 m above ground computed" ;
  "RH" "10000 m above ground computed" ;
  "RH" "11000 m above ground computed" ;
  "LAPSERATE" "500-2 m above ground computed" ;
  "LAPSERATE" "1000-2 m above ground computed" ;
  "LAPSERATE" "500-80 m above ground computed" ;
  "LAPSERATE" "1000-80 m above ground computed" ;
  "LAPSERATE" "2000-2 m above ground computed" ;
  "LAPSERATE" "3000-2 m above ground computed" ;
  "LAPSERATE" "4500-80 m above ground computed" ;
  "LAPSERATE" "6000-80 m above ground computed" ;
  "LAPSERATE" "10000-80 m above ground computed" ;
  "LAPSERATE" "1000-250 m above ground computed" ;
  "LAPSERATE" "2000-250 m above ground computed" ;
  "LAPSERATE" "8000-250 m above ground computed" ;
  "LAPSERATE" "1500-500 m above ground computed" ;
  "LAPSERATE" "3000-500 m above ground computed" ;
  "LAPSERATE" "4500-500 m above ground computed" ;
  "LAPSERATE" "3000-1000 m above ground computed" ;
  "LAPSERATE" "5000-2000 m above ground computed" ;
  "LAPSERATE" "500-700 mb computed" ;
  "VVEL" "column min" ;
  "VVEL" "column max" ;
  "VVEL" "column mean" ;
  "VVEL" "column stddev" ;
  "UGRD" "250 m above ground computed" ;
  "VGRD" "250 m above ground computed" ;
  "UGRD" "500 m above ground computed" ;
  "VGRD" "500 m above ground computed" ;
  "UGRD" "750 m above ground computed" ;
  "VGRD" "750 m above ground computed" ;
  "UGRD" "1000 m above ground computed" ;
  "VGRD" "1000 m above ground computed" ;
  "UGRD" "1500 m above ground computed" ;
  "VGRD" "1500 m above ground computed" ;
  "UGRD" "2000 m above ground computed" ;
  "VGRD" "2000 m above ground computed" ;
  "UGRD" "3000 m above ground computed" ;
  "VGRD" "3000 m above ground computed" ;
  "UGRD" "4500 m above ground computed" ;
  "VGRD" "4500 m above ground computed" ;
  "UGRD" "5000 m above ground computed" ;
  "VGRD" "5000 m above ground computed" ;
  "UGRD" "6000 m above ground computed" ;
  "VGRD" "6000 m above ground computed" ;
  "UGRD" "7000 m above ground computed" ;
  "VGRD" "7000 m above ground computed" ;
  "UGRD" "8000 m above ground computed" ;
  "VGRD" "8000 m above ground computed" ;
  "UGRD" "9000 m above ground computed" ;
  "VGRD" "9000 m above ground computed" ;
  "UGRD" "10000 m above ground computed" ;
  "VGRD" "10000 m above ground computed" ;
  "UGRD" "11000 m above ground computed" ;
  "VGRD" "11000 m above ground computed" ;
  "VUCSH" "6000-10 m above ground computed" ;
  "VVCSH" "6000-10 m above ground computed" ;
  "VUCSH" "2000-10 m above ground computed" ;
  "VVCSH" "2000-10 m above ground computed" ;
  "VUCSH" "3000-10 m above ground computed" ;
  "VVCSH" "3000-10 m above ground computed" ;
  "VUCSH" "4500-10 m above ground computed" ;
  "VVCSH" "4500-10 m above ground computed" ;
  "VUCSH" "6000-10 m above ground computed" ;
  "VVCSH" "6000-10 m above ground computed" ;
  "VUCSH" "10000-10 m above ground computed" ;
  "VVCSH" "10000-10 m above ground computed" ;
  "VUCSH" "1000-250 m above ground computed" ;
  "VVCSH" "1000-250 m above ground computed" ;
  "VUCSH" "2000-250 m above ground computed" ;
  "VVCSH" "2000-250 m above ground computed" ;
  "VUCSH" "8000-250 m above ground computed" ;
  "VVCSH" "8000-250 m above ground computed" ;
  "VUCSH" "1500-500 m above ground computed" ;
  "VVCSH" "1500-500 m above ground computed" ;
  "VUCSH" "3000-500 m above ground computed" ;
  "VVCSH" "3000-500 m above ground computed" ;
  "VUCSH" "4500-500 m above ground computed" ;
  "VVCSH" "4500-500 m above ground computed" ;
  "VUCSH" "3000-1000 m above ground computed" ;
  "VVCSH" "3000-1000 m above ground computed" ;
  "VUCSH" "5000-2000 m above ground computed" ;
  "VVCSH" "5000-2000 m above ground computed" ;
])
...
# all computed layers are rotated as well
uv_layers_to_rotate = [
...
function linear_interpolate(key, low_key, low_val, high_key, high_val)
  ratio = (key - low_key) / (high_key - low_key)
  low_val + ratio * (high_val - low_val)
end

# HOW HARD IS IT TO DO LINEAR INTERPOLATION?
#
# YYYYUUUUUUUUUUUUUUUUUUUCCCCKKKK
#
# Returns (list of (u_layer, v_layer), list of temp layers, list of relative humidity layers)
function compute_agl_layers(layer_to_data, agls)
  agls = sort(agls)
  mbs  = collect(1000:-25:100)

  surface_gpm_layer = layer_to_data["HGT:surface"]

  pressure_agl_layers = map(mb -> layer_to_data["HGT:$mb mb"] - surface_gpm_layer, mbs)

  pressure_u_layers   = map(mb -> layer_to_data["UGRD:$mb mb"], mbs)
  pressure_v_layers   = map(mb -> layer_to_data["VGRD:$mb mb"], mbs)
  pressure_tmp_layers = map(mb -> layer_to_data["TMP:$mb mb"], mbs)
  pressure_rh_layers  = map(mb -> layer_to_data["RH:$mb mb"], mbs)

  fixed_80m_agl_u_layer   = layer_to_data["UGRD:80 m above ground"]
  fixed_80m_agl_v_layer   = layer_to_data["VGRD:80 m above ground"]
  fixed_80m_agl_tmp_layer = layer_to_data["TMP:80 m above ground"]
  fixed_2m_agl_rh_layer   = layer_to_data["RH:2 m above ground"] # no 80m agl layer for rh

  agl_u_layers   = map(agl -> zeros(Float32, size(surface_gpm_layer)), agls)
  agl_v_layers   = map(agl -> zeros(Float32, size(surface_gpm_layer)), agls)
  agl_tmp_layers = map(agl -> zeros(Float32, size(surface_gpm_layer)), agls)
  agl_rh_layers  = map(agl -> zeros(Float32, size(surface_gpm_layer)), agls)

  for i in 1:length(surface_gpm_layer)
    lo_agl = 80

    hi_mb_i = 1
    hi_agl = pressure_agl_layers[hi_mb_i][i]
    while hi_agl <= lo_agl
      hi_mb_i += 1
      hi_agl = pressure_agl_layers[hi_mb_i][i]
    end

    for target_agl_i in 1:length(agls)
      target_agl = agls[target_agl_i]

      while !(target_agl >= lo_agl && target_agl <= hi_agl)
        lo_agl = hi_agl
      ...
      if lo_agl == 80
        lo_u   = fixed_80m_agl_u_layer[i]
        lo_v   = fixed_80m_agl_v_layer[i]
        lo_tmp = fixed_80m_agl_tmp_layer[i]
        lo_rh  = fixed_2m_agl_rh_layer[i] # 2m (no 80m available)--special case below.
      else
        lo_u   = pressure_u_layers[hi_mb_i-1][i]
        lo_v   = pressure_v_layers[hi_mb_i-1][i]
        lo_tmp = pressure_tmp_layers[hi_mb_i-1][i]
        lo_rh  = pressure_rh_layers[hi_mb_i-1][i]
      end
      hi_u   = pressure_u_layers[hi_mb_i][i]
      hi_v   = pressure_v_layers[hi_mb_i][i]
      hi_tmp = pressure_tmp_layers[hi_mb_i][i]
      hi_rh  = pressure_rh_layers[hi_mb_i][i]

      agl_u_layers[target_agl_i][i]   = linear_interpolate(target_agl, lo_agl, lo_u,   hi_agl, hi_u)
      agl_v_layers[target_agl_i][i]   = linear_interpolate(target_agl, lo_agl, lo_v,   hi_agl, hi_v)
      agl_tmp_layers[target_agl_i][i] = linear_interpolate(target_agl, lo_agl, lo_tmp, hi_agl, hi_tmp)
      if lo_agl == 80 # Then use 2m instead for RH
        agl_rh_layers[target_agl_i][i]  = linear_interpolate(target_agl, 2, lo_rh,  hi_agl, hi_rh)
      else
        agl_rh_layers[target_agl_i][i]  = linear_interpolate(target_agl, lo_agl, lo_rh,  hi_agl, hi_rh)
      end
    end
  end

  ( collect(zip(agl_u_layers, agl_v_layers))
  , agl_tmp_layers
  , agl_rh_layers
  )
end
...
function get_raw_data(grib2_path, forecast_hour, layers_to_use, uv_layers_to_rotate)
  ...
  println("Computing wind/temp/humidity/dewpoint layers at various heights above ground...")

  agls = [250, 500, 750, 1000, 1500, 2000, 3000, 4500, 5000, 6000, 7000, 8000, 9000, 10000, 11000] # meters

  agl_wind_layers, agl_temp_layers, agl_relative_humidity_layers = compute_agl_layers(layer_to_data, agls) # Functional programming...doesn't mutate layer_to_data

  for (agl, (us, vs), tmps, rhs) in zip(agls, agl_wind_layers, agl_temp_layers, agl_relative_humidity_layers)
    u_layer_key   = "UGRD:$(agl) m above ground computed"
    v_layer_key   = "VGRD:$(agl) m above ground computed"
    tmp_layer_key = "TMP:$(agl) m above ground computed"
    rh_layer_key  = "RH:$(agl) m above ground computed"

    layer_to_data[u_layer_key]   = us
    layer_to_data[v_layer_key]   = vs
    layer_to_data[tmp_layer_key] = tmps
    layer_to_data[rh_layer_key]  = rhs

    uv_layers_to_rotate = [uv_layers_to_rotate; (u_layer_key, v_layer_key)]
  end

  println("Computing more vertical shear parameters...")

  for (lo_agl, hi_agl) in [ (10,1000), (10,2000), (10,3000), (10,4500), (10,6000), (10,10000), (250,1000), (250,2000), (250,8000), (500,1500), (500,3000), (500,4500), (1000,3000), (2000,5000) ]
    if lo_agl == 10
      lo_u_layer_key = "UGRD:10 m above ground"
      lo_v_layer_key = "VGRD:10 m above ground"
    else
      lo_u_layer_key = "UGRD:$(lo_agl) m above ground computed"
      lo_v_layer_key = "VGRD:$(lo_agl) m above ground computed"
    end
    hi_u_layer_key = "UGRD:$(hi_agl) m above ground computed"
    hi_v_layer_key = "VGRD:$(hi_agl) m above ground computed"

    shear_u_layer_key = "VUCSH:$(hi_agl)-$(lo_agl) m above ground computed"
    shear_v_layer_key = "VVCSH:$(hi_agl)-$(lo_agl) m above ground computed"

    distance_m = Float32(hi_agl - lo_agl) # So units are 1/s

    layer_to_data[shear_u_layer_key] = (layer_to_data[hi_u_layer_key] - layer_to_data[lo_u_layer_key]) ./ distance_m
    layer_to_data[shear_v_layer_key] = (layer_to_data[hi_v_layer_key] - layer_to_data[lo_v_layer_key]) ./ distance_m

    uv_layers_to_rotate = [uv_layers_to_rotate; (shear_u_layer_key, shear_v_layer_key)]
  end

  println("Computing lapse rates...")

  # 0-3km is "low level lapse rate" on SPC mesoscale analysis page
  # 7000-500mb is "mid level lapse rate" on SPC mesoscale analysis page
  for (lo_agl, hi_agl) in [ (2,500), (2,1000), (80,500), (80,1000), (2,2000), (2,3000), (80,4500), (80,6000), (80,10000), (250,1000), (250,2000), (250,8000), (500,1500), (500,3000), (500,4500), (1000,3000), (2000,5000) ]
    if lo_agl == 2
      lo_tmp_layer_key = "TMP:2 m above ground"
    elseif lo_agl == 80
      lo_tmp_layer_key = "TMP:80 m above ground"
    else
      lo_tmp_layer_key = "TMP:$(lo_agl) m above ground computed"
    end
    hi_tmp_layer_key = "TMP:$(hi_agl) m above ground computed"

    lapse_rate_layer_key = "LAPSERATE:$(hi_agl)-$(lo_agl) m above ground computed"

    distance_km = Float32((hi_agl - lo_agl) /  1000.0)

    # Lapse rates are positive (it's the amount of lapsing)
    layer_to_data[lapse_rate_layer_key] = (layer_to_data[lo_tmp_layer_key] - layer_to_data[hi_tmp_layer_key]) / distance_km
  end
  # Compute "mid level" lapse rate
  distances_km = (layer_to_data["HGT:500 mb"] - layer_to_data["HGT:700 mb"]) / 1000f0
  layer_to_data["LAPSERATE:500-700 mb computed"] = (layer_to_data["TMP:700 mb"] - layer_to_data["TMP:500 mb"]) ./ distances_km


  println("Computing vertical velocity min/max/mean/stddev...")

  mbs  = collect(1000:-25:100)

  surface_gpm_layer = layer_to_data["HGT:surface"]

  pressure_vvel_layers = map(mb -> layer_to_data["VVEL:$mb mb"], mbs)

  vvel_min_layer    = zeros(Float32, size(surface_gpm_layer))
  vvel_max_layer    = zeros(Float32, size(surface_gpm_layer))
  vvel_mean_layer   = zeros(Float32, size(surface_gpm_layer))
  vvel_stddev_layer = zeros(Float32, size(surface_gpm_layer))

  column_vvels = zeros(Float32, size(mbs))

  for i in 1:length(surface_gpm_layer)
    for mb_i in 1:length(mbs)
      column_vvels[mb_i] = pressure_vvel_layers[mb_i][i]
    end
    vvel_min_layer[i]    = minimum(column_vvels)
    vvel_max_layer[i]    = maximum(column_vvels)
    vvel_mean_layer[i]   = mean(column_vvels)
    vvel_stddev_layer[i] = std(column_vvels)
  end

  layer_to_data["VVEL:column min"]    = vvel_min_layer
  layer_to_data["VVEL:column max"]    = vvel_max_layer
  layer_to_data["VVEL:column mean"]   = vvel_mean_layer
  layer_to_data["VVEL:column stddev"] = vvel_stddev_layer


  println("Rotating...")

  for uv_layer in uv_layers_to_rotate
  ...
  consolidated_data = zeros(Float32, size(layers_to_use,1), grid_width*grid_height)
  i = 1

  for layer_i in 1:size(layers_to_use,1)
    abbrev, desc = layers_to_use[layer_i,:]
...
consolidated_data, regular_layer_order, wind_layer_order, storm_motion_us_j, storm_motion_vs_j = get_raw_data(grib2_path, forecast_hour, layers_to_use, uv_layers_to_rotate)
...
prior_hour_consolidated_data, _, _, _, _                                                       = get_raw_data(prior_forecast_hour_grib2_path, forecast_hour-1, layers_to_use, uv_layers_to_rotate)
