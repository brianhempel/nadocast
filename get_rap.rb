...
FORECAST_HOURS = [1,2,6,12,18] # RAP forcasts 0 - 21 hours ahead, but only 0-18 are available. +2 hours is the first real forecast, the first hour is data assimilation.
