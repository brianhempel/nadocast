...
# nadocaster2: JULIA_NUM_THREADS=$CORE_COUNT ONLY_BEFORE=2020-5-23 ONLY_FEATURES_PATH=~/nadocast_dev/models/href_mid_2018_forward/features_2021v2_mean_prob_computed_climatology_blurs_n=910.txt EVENT_TYPES=tornado,wind,hail MUST_LOAD_FROM_DISK=true FORECAST_HOUR_RANGE=2:13 DATA_SUBSET_RATIO=0.03 NEAR_STORM_RATIO=0.4 time julia --project=~/nadocast_dev ~/nadocast_dev/models/href_mid_2018_forward/TrainGradientBoostedDecisionTrees.jl > href_f2-13_only_before_20200523_tornado_wind_hail_hail_mean_prob_computed_climatology_blurs_n=910_stdout.txt
# nadocaster: JULIA_NUM_THREADS=$CORE_COUNT ONLY_BEFORE=2020-5-23 ONLY_FEATURES_PATH=~/nadocast_dev/models/href_mid_2018_forward/features_2021v2_mean_prob_computed_climatology_blurs_n=910.txt EVENT_TYPES=tornado,wind,hail MUST_LOAD_FROM_DISK=true FORECAST_HOUR_RANGE=13:24 DATA_SUBSET_RATIO=0.03 NEAR_STORM_RATIO=0.4 time julia --project=~/nadocast_dev ~/nadocast_dev/models/href_mid_2018_forward/TrainGradientBoostedDecisionTrees.jl > href_f13-24_only_before_20200523_tornado_wind_hail_hail_mean_prob_computed_climatology_blurs_n=910_stdout.txt
# nadocaster: JULIA_NUM_THREADS=$CORE_COUNT ONLY_BEFORE=2020-5-23 ONLY_FEATURES_PATH=~/nadocast_dev/models/href_mid_2018_forward/features_2021v2_mean_prob_computed_climatology_blurs_n=910.txt EVENT_TYPES=tornado,wind,hail MUST_LOAD_FROM_DISK=true FORECAST_HOUR_RANGE=24:35 DATA_SUBSET_RATIO=0.03 NEAR_STORM_RATIO=0.4 time julia --project=~/nadocast_dev ~/nadocast_dev/models/href_mid_2018_forward/TrainGradientBoostedDecisionTrees.jl > href_f24-35_only_before_20200523_tornado_wind_hail_hail_mean_prob_computed_climatology_blurs_n=910_stdout.txt
