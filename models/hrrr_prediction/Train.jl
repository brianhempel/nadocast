...
(_, validation_forecasts_blurred, _) = TrainingShared.forecasts_train_validation_test(HRRRPrediction.forecasts_blurred_and_forecast_hour(); just_hours_near_storm_events = false);
