...
interaction_terms = [
  ...
  (    "SBCAPE*BWD0-6km*HLCY1000-0m", (_, get_layer, out) -> out .= get_layer(    "SBCAPE*BWD0-6km") .* get_layer(helicity1km_key)),
  (    "MLCAPE*BWD0-6km*HLCY1000-0m", (_, get_layer, out) -> out .= get_layer(    "MLCAPE*BWD0-6km") .* get_layer(helicity1km_key)),
  (      "LFTX*BWD0-6km*HLCY1000-0m", (_, get_layer, out) -> out .= get_layer(      "LFTX*BWD0-6km") .* get_layer(helicity1km_key)),
  ("sqrtSBCAPE*BWD0-6km*HLCY1000-0m", (_, get_layer, out) -> out .= get_layer("sqrtSBCAPE*BWD0-6km") .* get_layer(helicity1km_key)),
  ("sqrtMLCAPE*BWD0-6km*HLCY1000-0m", (_, get_layer, out) -> out .= get_layer("sqrtMLCAPE*BWD0-6km") .* get_layer(helicity1km_key)),
  ...
  ("Divergence80m*10^5", (grid, get_layer, out) -> FeatureEngineeringShared.compute_divergence_threaded!(grid, out, get_layer("UGRD:80 m above ground:hour fcst:"), get_layer("VGRD:80 m above ground:hour fcst:"))),
  ...
  ("StormUpstream80mConvergence3hrGatedBySCP"                 , (grid, get_layer, out) ->                  storm_upstream_feature_gated_by_SCP!(grid, get_layer, out, "ConvergenceOnly80m*10^5"             , hours = 3)),
  ("StormUpstream80mConvergence6hrGatedBySCP"                 , (grid, get_layer, out) ->                  storm_upstream_feature_gated_by_SCP!(grid, get_layer, out, "ConvergenceOnly80m*10^5"             , hours = 6)),
  ("StormUpstream80mConvergence9hrGatedBySCP"                 , (grid, get_layer, out) ->                  storm_upstream_feature_gated_by_SCP!(grid, get_layer, out, "ConvergenceOnly80m*10^5"             , hours = 9)),
  ...
  ("UpstreamMLCAPE1hr", (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, mlcape_key      , hours = 1)),
  ("UpstreamMLCAPE2hr", (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, mlcape_key      , hours = 2)),

  ("UpstreamLFTX1hr"  , (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, lifted_index_key, hours = 1)),
  ("UpstreamLFTX2hr"  , (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, lifted_index_key, hours = 2)),

  ("Upstream2mDPT1hr" , (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, dpt_key         , hours = 1)),
  ("Upstream2mDPT2hr" , (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, dpt_key         , hours = 2)),

  ("Upstream2mRH1hr"  , (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, rh_key          , hours = 1)),
  ("Upstream2mRH2hr"  , (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, rh_key          , hours = 2)),

  ("UpstreamPRATE1hr" , (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, percip_rate_key , hours = 1)),
  ("UpstreamPRATE2hr" , (grid, get_layer, out) -> upstream_feature!(grid, get_layer, out, above_surface_u_key, above_surface_v_key, percip_rate_key , hours = 2)),
]
...
function reload_forecasts()
  # HRRR_1 contains runs through 2018-10
  # HRRR_2 contains runs 2018-11 and forward
  hrrr_paths = vcat(
