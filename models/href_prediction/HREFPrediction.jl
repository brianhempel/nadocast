...
function reload_forecasts()
  ...
  event_to_bins = Dict{String, Vector{Float32}}(
    ...
    "wind_adj"        => [0.007293307,   0.019115837,  0.036141146,  0.06361171,  0.11529552,  1.0],
    ...
    "sig_wind_adj"    => [0.0007026063,  0.002175051,  0.0047103437, 0.008226235, 0.014878796, 1.0],
  ...
  event_to_bins_logistic_coeffs = Dict{String, Vector{Vector{Float32}}}(
    ...
    "wind_adj"        => [[1.0835536,  0.3302101],   [1.1271127, 0.5125384],    [1.0838023,  0.35807598],   [1.0530577,  0.26911345], [0.9993558, 0.12850402]],
    ...
    "sig_wind_adj"    => [[1.0980748,  0.74092144],  [1.0278105, 0.2092408],    [1.3354824,  1.9728225],    [1.0461866,  0.5070991],  [0.8209114, -0.47899055]],
