...
interaction_terms = [
  ...
  (    "SBCAPE*BWD0-6km*HLCY1000-0m", (_, get_layer) -> get_layer(    "SBCAPE*HLCY1000-0m") .* get_layer("BWD0-6km")),
  (    "MLCAPE*BWD0-6km*HLCY1000-0m", (_, get_layer) -> get_layer(    "MLCAPE*HLCY1000-0m") .* get_layer("BWD0-6km")),
  (      "LFTX*BWD0-6km*HLCY1000-0m", (_, get_layer) -> get_layer(      "LFTX*HLCY1000-0m") .* get_layer("BWD0-6km")),
  ("sqrtSBCAPE*BWD0-6km*HLCY1000-0m", (_, get_layer) -> get_layer("sqrtSBCAPE*HLCY1000-0m") .* get_layer("BWD0-6km")),
  ("sqrtMLCAPE*BWD0-6km*HLCY1000-0m", (_, get_layer) -> get_layer("sqrtMLCAPE*HLCY1000-0m") .* get_layer("BWD0-6km")),
  ...
  ("StormUpstream30-0mbConvergence3hrGatedBySCP"              , (grid, get_layer) ->           storm_upstream_feature_gated_by_SCP(grid, get_layer, "ConvergenceOnly30-0mb*10^5"          , hours = 3)),
  ("StormUpstream30-0mbConvergence6hrGatedBySCP"              , (grid, get_layer) ->           storm_upstream_feature_gated_by_SCP(grid, get_layer, "ConvergenceOnly30-0mb*10^5"          , hours = 6)),
  ("StormUpstream30-0mbConvergence9hrGatedBySCP"              , (grid, get_layer) ->           storm_upstream_feature_gated_by_SCP(grid, get_layer, "ConvergenceOnly30-0mb*10^5"          , hours = 9)),
  ...
  ("UpstreamMLCAPE1hr",          (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, mlcape_key      , hours = 1)),
  ("UpstreamMLCAPE2hr",          (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, mlcape_key      , hours = 2)),

  ("UpstreamLFTX1hr"  ,          (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, lifted_index_key, hours = 1)),
  ("UpstreamLFTX2hr"  ,          (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, lifted_index_key, hours = 2)),

  ("Upstream2mDPT1hr" ,          (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, dpt_key         , hours = 1)),
  ("Upstream2mDPT2hr" ,          (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, dpt_key         , hours = 2)),

  ("UpstreamSurfaceLayerRH1hr" , (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, rh_key          , hours = 1)),
  ("UpstreamSurfaceLayerRH2hr" , (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, rh_key          , hours = 2)),

  ("UpstreamPRATE1hr" ,          (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, percip_rate_key , hours = 1)),
  ("UpstreamPRATE2hr" ,          (grid, get_layer) -> upstream_feature(grid, get_layer, surface_layer_u_key, surface_layer_v_key, percip_rate_key , hours = 2)),
]
