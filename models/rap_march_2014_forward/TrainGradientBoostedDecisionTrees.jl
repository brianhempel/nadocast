...
TrainGBDTShared.train_with_coordinate_descent_hyperparameter_search(
    ...
    training_X_and_labels_to_inclusion_probabilities   = (X, labels) -> max.(0.004f0, labels),
    validation_X_and_labels_to_inclusion_probabilities = (X, labels) -> max.(0.02f0, labels),
